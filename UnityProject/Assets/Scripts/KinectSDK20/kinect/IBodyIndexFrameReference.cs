...
namespace KinectSDK20 {
    public class IBodyIndexFrameReference: IUnknown
    {
        static Guid s_uuid = new Guid("d0ea0519-f7e7-4b1e-b3d8-03b3c002795f");
        ...
        public virtual int AcquireFrame(
            ...
            return m_AcquireFrameFunc(m_ptr, out bodyIndexFrame.PtrForNew);
        }
        delegate int AcquireFrameFunc(IntPtr self, out IntPtr bodyIndexFrame);
