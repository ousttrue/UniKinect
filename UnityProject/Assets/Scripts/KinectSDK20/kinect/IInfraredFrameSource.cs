...
namespace KinectSDK20 {
    public class IInfraredFrameSource: IUnknown
    {
        static Guid s_uuid = new Guid("4c299ec6-ca45-4aff-87ad-df5762c49be7");
        ...
        public virtual int OpenReader(
            out IInfraredFrameReader reader
        ){
            ...
            reader = new IInfraredFrameReader();
