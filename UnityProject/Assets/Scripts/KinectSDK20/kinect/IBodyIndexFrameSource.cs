...
namespace KinectSDK20 {
    public class IBodyIndexFrameSource: IUnknown
    {
        static Guid s_uuid = new Guid("010f2a40-dc58-44a5-8e57-329a583fec08");
        ...
        public virtual int OpenReader(
            out IBodyIndexFrameReader reader
        ){
            ...
            reader = new IBodyIndexFrameReader();
