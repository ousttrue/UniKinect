...
namespace KinectSDK20 {
    public class IInfraredFrameReader: IUnknown
    {
        static Guid s_uuid = new Guid("059a049d-a0ac-481e-b342-483ee94a028b");
        ...
        public virtual int GetFrameArrivedEventData(
            long waitableHandle,
            out IInfraredFrameArrivedEventArgs eventData
        ){
            ...
            eventData = new IInfraredFrameArrivedEventArgs();
        ...
        public virtual int AcquireLatestFrame(
            ...
            return m_AcquireLatestFrameFunc(m_ptr, out infraredFrame.PtrForNew);
        }
        delegate int AcquireLatestFrameFunc(IntPtr self, out IntPtr infraredFrame);
