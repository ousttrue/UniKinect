...
namespace KinectSDK20 {
    public class IDepthFrameReader: IUnknown
    {
        static Guid s_uuid = new Guid("81c0c0ab-6e6c-45cb-8625-a5f4d38759a4");
        ...
        public virtual int GetFrameArrivedEventData(
            long waitableHandle,
            out IDepthFrameArrivedEventArgs eventData
        ){
            ...
            eventData = new IDepthFrameArrivedEventArgs();
        ...
        public virtual int AcquireLatestFrame(
            ...
            return m_AcquireLatestFrameFunc(m_ptr, out depthFrame.PtrForNew);
        }
        delegate int AcquireLatestFrameFunc(IntPtr self, out IntPtr depthFrame);
