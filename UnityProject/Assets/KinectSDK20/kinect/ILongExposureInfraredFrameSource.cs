...
namespace KinectSDK20 {
    public class ILongExposureInfraredFrameSource: IUnknown
    {
        static Guid s_uuid = new Guid("d7150eda-eda2-4673-b4f8-e3c76d1f402b");
        ...
        public virtual int OpenReader(
            out ILongExposureInfraredFrameReader reader
        ){
            ...
            reader = new ILongExposureInfraredFrameReader();
